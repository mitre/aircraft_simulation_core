...
class ShapeOnEllipsoid {
  public:
    ...
    */
   virtual bool IsPointOnShape(const LatitudeLongitudePoint &test_point) const { return false; }
   ...
   /**
    * Project from point_not_on_shape to the shape, making a perpendicular line through the shape. Return that point
    * that has been calculated as the projected point.
    *
